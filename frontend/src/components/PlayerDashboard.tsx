    ...
    <div className={`jersey-card relative ${isBench ? 'bench' : ''} ${isCaptain ? 'captain' : ''} ${player.haul_alert ? 'border-orange-500/50 shadow-[0_0_15px_rgba(234,88,12,0.15)]' : ''}`}>
        ...
        {player.haul_alert && (
            <div
                ...
                className="flex items-center gap-1 bg-gradient-to-r from-orange-600 to-red-600 rounded-full px-1.5 py-0.5 shadow-[0_0_10px_rgba(234,88,12,0.4)] animate-pulse border border-orange-400/30"
            >
