...
const MiniPlayerCard = ({ player, isBench = false, isCaptain = false }: { player: any, isBench?: boolean, isCaptain?: boolean }) => (
    <div className={`jersey-card relative ${isBench ? 'bench' : ''} ${isCaptain ? 'captain' : ''} ${player.haul_alert ? 'border-orange-500/50 shadow-[0_0_15px_rgba(234,88,12,0.15)]' : ''} !flex !flex-col !justify-between !pt-7 !pb-2`}>
        ...
        <div className="flex flex-col items-center flex-1 justify-center">
            ...
            <div className="mt-0.5 flex flex-col items-center">
                {/* Haul Alert - In Flow */}
                {player.haul_alert && (
                    <div className="mb-0.5 flex items-center gap-1 bg-gradient-to-r from-orange-600 to-red-600 rounded-full px-1.5 py-0.5 shadow-[0_0_10px_rgba(234,88,12,0.4)] animate-pulse border border-orange-400/30 whitespace-nowrap">
