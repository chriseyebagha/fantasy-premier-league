...
const MiniPlayerCard = ({ player, isBench = false, isCaptain = false }: { player: any, isBench?: boolean, isCaptain?: boolean }) => (
    <div className={`jersey-card relative ${isBench ? 'bench' : ''} ${isCaptain ? 'captain' : ''} ${player.haul_alert ? 'border-orange-500/50 shadow-[0_0_15px_rgba(234,88,12,0.15)]' : ''}`}>
        ...
        <div className="flex flex-col items-center flex-1 justify-center">
            ...
            {/* Haul & Alert Container - Relative for Absolute Alert Positioning */}
            <div className="relative mt-0.5 flex flex-col items-center">
                {/* Haul Alert - Absolute Positioned to float above without taking space */}
                {player.haul_alert && (
                    <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-0.5 flex items-center gap-1 bg-gradient-to-r from-orange-600 to-red-600 rounded-full px-1.5 py-0.5 shadow-[0_0_10px_rgba(234,88,12,0.4)] animate-pulse border border-orange-400/30 whitespace-nowrap z-20">
